...
{	
	...
	if (imloaded == 1)
	{
		...
		/* 
		*
		*	Step 1: Project 2D image pixels to 3D ( for image 1 ) 
		*	Step 2: Add the depth into the resulting image Matrix from step 1.
		*	Step 3: Apply the sceneflow vectors calculated from the classical software.
		*	Step 4: Reproject the resulting matrix onto the 2D plane ( this step might be divided into 
		*			further steps)
		*/
